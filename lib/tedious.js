...
const tediousTypes = {
  [TYPES.VarChar] : tds.TYPES.VarChar,
  [TYPES.NVarChar] : tds.TYPES.NVarChar,
  [TYPES.Text] : tds.TYPES.Text,
  [TYPES.Int] : tds.TYPES.Int,
  [TYPES.BigInt] : tds.TYPES.BigInt,
  [TYPES.TinyInt] : tds.TYPES.TinyInt,
  [TYPES.SmallInt] : tds.TYPES.SmallInt,
  [TYPES.Bit] : tds.TYPES.Bit,
  [TYPES.Float] : tds.TYPES.Float,
  [TYPES.Decimal] : tds.TYPES.Decimal,
  [TYPES.Numeric] : tds.TYPES.Numeric,
  [TYPES.Real] : tds.TYPES.Real,
  [TYPES.Money] : tds.TYPES.Money,
  [TYPES.SmallMoney] : tds.TYPES.SmallMoney,
  [TYPES.Time] : tds.TYPES.Time,
  [TYPES.Date] : tds.TYPES.Date,
  [TYPES.DateTime] : tds.TYPES.DateTime,
  [TYPES.DateTime2] : tds.TYPES.DateTime2,
  [TYPES.DateTimeOffset] : tds.TYPES.DateTimeOffset,
  [TYPES.SmallDateTime] : tds.TYPES.SmallDateTime,
  [TYPES.UniqueIdentifier] : tds.TYPES.UniqueIdentifier,
  [TYPES.Xml] : tds.TYPES.NVarChar,
  [TYPES.Char] : tds.TYPES.Char,
  [TYPES.NChar] : tds.TYPES.NChar,
  [TYPES.NText] : tds.TYPES.NVarChar,
  [TYPES.Image] : tds.TYPES.Image,
  [TYPES.Binary] : tds.TYPES.Binary,
  [TYPES.VarBinary] : tds.TYPES.VarBinary,
  [TYPES.UDT] : tds.TYPES.UDT,
  [TYPES.Geography] : tds.TYPES.UDT,
  [TYPES.Geometry] : tds.TYPES.UDT,
  [TYPES.TVP] : tds.TYPES.TVP,
  [TYPES.Variant] : tds.TYPES.Variant,
}

const getTediousType = function (type) {
  const commonType = tediousTypes[type] || type;
  return commonType;
}

const mssqlTypes = {
  [tds.TYPES.Char.id] : TYPES.Char,
  [tds.TYPES.NChar.id] : TYPES.NChar,
  [tds.TYPES.VarChar.id] : TYPES.VarChar,
  [tds.TYPES.NVarChar.id] : TYPES.NVarChar,
  [tds.TYPES.Text.id] : TYPES.Text,
  [tds.TYPES.NText.id] : TYPES.NText,
  [tds.TYPES.Int.id] : TYPES.Int,
  [tds.TYPES.BigInt.id] : TYPES.BigInt,
  [tds.TYPES.TinyInt.id] : TYPES.TinyInt,
  [tds.TYPES.SmallInt.id] : TYPES.SmallInt,
  [tds.TYPES.Bit.id] : TYPES.Bit,
  [tds.TYPES.Float.id] : TYPES.Float,
  [tds.TYPES.Real.id] : TYPES.Real,
  [tds.TYPES.Money.id] : TYPES.Money,
  [tds.TYPES.SmallMoney.id] : TYPES.SmallMoney,
  [tds.TYPES.Numeric.id] : TYPES.Numeric,
  [tds.TYPES.Decimal.id] : TYPES.Decimal,
  [tds.TYPES.DateTime.id] : TYPES.DateTime,
  [tds.TYPES.Time.id] : TYPES.Time,
  [tds.TYPES.Date.id] : TYPES.Date,
  [tds.TYPES.DateTime2.id] : TYPES.DateTime2,
  [tds.TYPES.DateTimeOffset.id] : TYPES.DateTimeOffset,
  [tds.TYPES.SmallDateTime.id] : TYPES.SmallDateTime,
  [tds.TYPES.UniqueIdentifier.id] : TYPES.UniqueIdentifier,
  [tds.TYPES.Image.id] : TYPES.Image,
  [tds.TYPES.Binary.id] : TYPES.Binary,
  [tds.TYPES.VarBinary.id] : TYPES.VarBinary,
  [tds.TYPES.Xml.id] : TYPES.Xml,
  [tds.TYPES.UDT.id] : TYPES.UDT,
  [tds.TYPES.TVP.id] : TYPES.TVP,
  [tds.TYPES.Variant.id] : TYPES.Variant,
  [N_TYPES.BitN] : TYPES.Bit,
  [N_TYPES.NumericN] : TYPES.Numeric,
  [N_TYPES.DecimalN] : TYPES.Decimal,
  [N_TYPES.IntN] : {
    getType : (length) => {
      if (length === 8) {
        return TYPES.BigInt
...
const getMssqlType = function (type, length) {
  ...
  const commonType = mssqlTypes[type.id];

  if (commonType instanceof Function) {
    return commonType;
  } else {
    if ('getType' in commonType) {
      return commonType.getType(length);
    } else {
      return commonType;
    }
  }
